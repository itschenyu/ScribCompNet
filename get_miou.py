...
if __name__ == "__main__":
    miou_mode       = 0 # 0: get all metrics, 1: get predict result, 2: get miou
    num_classes     = 7 # number of classes + 1
    name_classes    = ["background","bearing","bracing","deck","floor_beam","girder","substructure"] # class names
    ...
    if miou_mode == 0 or miou_mode == 1:
        ...
        print("Load model.")
        hrnet = ScribCompNet_Segmentation()
